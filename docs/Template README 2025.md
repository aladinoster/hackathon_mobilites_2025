...
Ce document est un exemple de README pour vos répertoire de code et pour présenter vos projets. Il vous aidera à faire vos [diapositives pour le pitch](https://drive.google.com/drive/folders/1F9pkX9DwDJxw5rXWIiKHeD_um1sa5BH9?usp=sharing). 
